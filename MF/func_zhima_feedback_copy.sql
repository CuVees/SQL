...
#######################
delete from reportdb.tb_zhima_feedback_copy where day_key=CURRENT_DATE ;
insert into reportdb.tb_zhima_feedback_copy (day_key,credit_id,user_credentials_type,user_credentials_no ,user_name,order_no,biz_type,pay_month,gmt_ovd_date,order_status,create_amt,overdue_days,overdue_amt,gmt_pay,memo)
SELECT
...
,arrive_time
from bmdb.tb_credit_record  where status in(3,4,5,6,7,8,12) and cre_update_time>=@stat and cre_update_time<date_add(@stat,INTERVAL 1 day) and 
order_no not in(
'201710201016257804',
'201710201016063911',
'201710201017362902',
